...
public final class RedisUtil {
    ...
    public void setRedisTemplate(StringRedisTemplate redisTemplate) {
        STRING_REDIS_TEMPLATE = redisTemplate;
    }
    ...
    public static void delete(Collection<String> keys) {
        STRING_REDIS_TEMPLATE.delete(keys);
    }
    ...
    public static byte[] dump(String key) {
        return STRING_REDIS_TEMPLATE.dump(key);
    }
    ...
    public static Long getExpire(String key, TimeUnit unit) {
        return STRING_REDIS_TEMPLATE.getExpire(key, unit);
    }
    ...
    public static String getRange(String key, long start, long end) {
        return STRING_REDIS_TEMPLATE.opsForValue().get(key, start, end);
    }
    ...
    public static List<String> multiGet(Collection<String> keys) {
        return STRING_REDIS_TEMPLATE.opsForValue().multiGet(keys);
    }
    ...
    public static void setRange(String key, String value, long offset) {
        STRING_REDIS_TEMPLATE.opsForValue().set(key, value, offset);
    }
    ...
    public static Long size(String key) {
        return STRING_REDIS_TEMPLATE.opsForValue().size(key);
    }
    ...
    public static void multiSet(Map<String, String> maps) {
        STRING_REDIS_TEMPLATE.opsForValue().multiSet(maps);
    }
    ...
    public static boolean multiSetIfAbsent(Map<String, String> maps) {
        return Boolean.TRUE.equals(STRING_REDIS_TEMPLATE.opsForValue().multiSetIfAbsent(maps));
    }
    ...
    public static Long incrBy(String key, long increment) {
        return STRING_REDIS_TEMPLATE.opsForValue().increment(key, increment);
    }
    ...
    public static Integer append(String key, String value) {
        return STRING_REDIS_TEMPLATE.opsForValue().append(key, value);
    }
    ...
    public static List<Object> hMultiGet(String key, Collection<Object> fields) {
        return STRING_REDIS_TEMPLATE.opsForHash().multiGet(key, fields);
    }
    ...
    public static void hPutAll(String key, Map<String, String> maps) {
        STRING_REDIS_TEMPLATE.opsForHash().putAll(key, maps);
    }
    ...
    public static Long hDelete(String key, Object... fields) {
        return STRING_REDIS_TEMPLATE.opsForHash().delete(key, fields);
    }
    ...
    public static boolean hExists(String key, String field) {
        return STRING_REDIS_TEMPLATE.opsForHash().hasKey(key, field);
    }
    ...
    public static Long hIncrBy(String key, Object field, long increment) {
        return STRING_REDIS_TEMPLATE.opsForHash().increment(key, field, increment);
    }
    ...
    public static Double hIncrByFloat(String key, Object field, double delta) {
        return STRING_REDIS_TEMPLATE.opsForHash().increment(key, field, delta);
    }
    ...
    public static Cursor<Entry<Object, Object>> hScan(String key, ScanOptions options) {
        return STRING_REDIS_TEMPLATE.opsForHash().scan(key, options);
    }
    ...
    public static Long lLeftPushAll(String key, String... value) {
        return STRING_REDIS_TEMPLATE.opsForList().leftPushAll(key, value);
    }
    ...
    public static Long lLeftPushIfPresent(String key, String value) {
        return STRING_REDIS_TEMPLATE.opsForList().leftPushIfPresent(key, value);
    }
    ...
    public static Long lLeftPush(String key, String pivot, String value) {
        return STRING_REDIS_TEMPLATE.opsForList().leftPush(key, pivot, value);
    }
    ...
    public static Long lRightPushAll(String key, String... value) {
        return STRING_REDIS_TEMPLATE.opsForList().rightPushAll(key, value);
    }
    ...
    public static Long lRightPushIfPresent(String key, String value) {
        return STRING_REDIS_TEMPLATE.opsForList().rightPushIfPresent(key, value);
    }
    ...
    public static Long lRightPush(String key, String pivot, String value) {
        return STRING_REDIS_TEMPLATE.opsForList().rightPush(key, pivot, value);
    }
    ...
    public static void lSet(String key, long index, String value) {
        STRING_REDIS_TEMPLATE.opsForList().set(key, index, value);
    }
    ...
    public static String lBLeftPop(String key, long timeout, TimeUnit unit) {
        return STRING_REDIS_TEMPLATE.opsForList().leftPop(key, timeout, unit);
    }
    ...
    public static String lBRightPop(String key, long timeout, TimeUnit unit) {
        return STRING_REDIS_TEMPLATE.opsForList().rightPop(key, timeout, unit);
    }
    ...
    public static String lRightPopAndLeftPush(String sourceKey, String destinationKey) {
        return STRING_REDIS_TEMPLATE.opsForList().rightPopAndLeftPush(sourceKey,
                destinationKey);
    }
    ...
    public static Long lRemove(String key, long index, String value) {
        return STRING_REDIS_TEMPLATE.opsForList().remove(key, index, value);
    }
    ...
    public static Set<String> sIntersect(String key, String otherKey) {
        return STRING_REDIS_TEMPLATE.opsForSet().intersect(key, otherKey);
    }
    ...
    public static Set<String> sIntersect(String key, Collection<String> otherKeys) {
        return STRING_REDIS_TEMPLATE.opsForSet().intersect(key, otherKeys);
    }
    ...
    public static Long sIntersectAndStore(String key, String otherKey, String destKey) {
        return STRING_REDIS_TEMPLATE.opsForSet().intersectAndStore(key, otherKey,
                destKey);
    }
    ...
    public static Long sIntersectAndStore(String key, Collection<String> otherKeys,
                                          String destKey) {
        return STRING_REDIS_TEMPLATE.opsForSet().intersectAndStore(key, otherKeys,
                destKey);
    }
    ...
    public static Long sDifference(String key, String otherKey, String destKey) {
        return STRING_REDIS_TEMPLATE.opsForSet().differenceAndStore(key, otherKey,
                destKey);
    }
    ...
    public static Long sDifference(String key, Collection<String> otherKeys,
                                   String destKey) {
        return STRING_REDIS_TEMPLATE.opsForSet().differenceAndStore(key, otherKeys,
                destKey);
    }
    ...
    public static Cursor<String> sScan(String key, ScanOptions options) {
        return STRING_REDIS_TEMPLATE.opsForSet().scan(key, options);
    }
    ...
    public static Long zAdd(String key, Set<TypedTuple<String>> values) {
        return STRING_REDIS_TEMPLATE.opsForZSet().add(key, values);
    }
    ...
    public static Double zIncrementScore(String key, String value, double delta) {
        return STRING_REDIS_TEMPLATE.opsForZSet().incrementScore(key, value, delta);
    }
    ...
    public static Set<TypedTuple<String>> zReverseRangeWithScores(String key,
                                                                  long start, long end) {
        return STRING_REDIS_TEMPLATE.opsForZSet().reverseRangeWithScores(key, start,
                end);
    }
    ...
    public static Set<TypedTuple<String>> zReverseRangeByScoreWithScores(
        ...
        return STRING_REDIS_TEMPLATE.opsForZSet().reverseRangeByScoreWithScores(key,
                min, max);
    }
    ...
    public static Long zZCard(String key) {
        return STRING_REDIS_TEMPLATE.opsForZSet().zCard(key);
    }
    ...
    public static Long zUnionAndStore(String key, Collection<String> otherKeys,
                                      String destKey) {
        return STRING_REDIS_TEMPLATE.opsForZSet()
    ...
    public static Long zIntersectAndStore(String key, String otherKey,
                                          String destKey) {
        return STRING_REDIS_TEMPLATE.opsForZSet().intersectAndStore(key, otherKey,
                destKey);
    }
    ...
    public static Long zIntersectAndStore(String key, Collection<String> otherKeys,
                                          String destKey) {
        return STRING_REDIS_TEMPLATE.opsForZSet().intersectAndStore(key, otherKeys,
                destKey);
    }
    ...
    public static Cursor<TypedTuple<String>> zScan(String key, ScanOptions options) {
        return STRING_REDIS_TEMPLATE.opsForZSet().scan(key, options);
    }
}